...
namespace DvMod.SteamCutoff
{
    public static class CylinderSimulation
    {
        ...
        public static float Cutoff(SteamLocoSimulation sim) => Constants.MinCutoff + Mathf.Pow(sim.cutoff.value, Constants.CutoffGamma) 
            * (Constants.MaxCutoff - Constants.MinCutoff);
